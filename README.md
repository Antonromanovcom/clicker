...
На текущем этапе реализованы интерфейс командной строки, планировщик и единый контракт жизненного цикла режимов. Программа определяет macOS, Windows или Linux, создаёт выбранный режим через фабрику, ожидает заданного старта и гарантированно останавливает режим при завершении. Сами режимы пока являются безопасными заглушками: приложение не меняет настройки сна и не управляет вводом.
